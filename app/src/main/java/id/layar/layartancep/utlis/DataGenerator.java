...
public class DataGenerator {
    ...
    public static ArrayList<Movies> generateDataMovie() {
        ...
        movies.add(new Movies("The Lion King","/dzBtMocZuJbjLOXvrl4zGYigDzh.jpg","Simba idolises his father, King Mufasa, and takes to heart his own royal destiny. But not everyone in the kingdom celebrates the new cub's arrival. Scar, Mufasa's brother—and former heir to the throne—has plans of his own. The battle for Pride Rock is ravaged with betrayal, tragedy and drama, ultimately resulting in Simba's exile. With help from a curious pair of newfound friends, Simba will have to figure out how to grow up and take back what is rightfully hi"));
        movies.add(new Movies("Detective Conan: The Fist of Blue Sapphire","/86Y6qM8zTn3PFVfCm9J98Ph7JEB.jpg","23rd movie in the \\\"Detective Conan\\\" franchise."));
        movies.add(new Movies("Spider-Man: Far from Home","/rjbNpRMoVvqHmhmksbokcyCr7wn.jpg","Peter Parker and his friends go on a summer trip to Europe. However, they will hardly be able to rest - Peter will have to agree to help Nick Fury uncover the mystery of creatures that cause natural disasters and destruction throughout the continent."));
        ...
        movies.add(new Movies("Pokémon Detective Pikachu","/wgQ7APnFpf1TuviKHXeEe3KnsTV.jpg","In a world where people collect pocket-size monsters (Pokémon) to do battle, a boy comes across an intelligent monster who seeks to be a detective."));
        movies.add(new Movies("Alita: Battle Angel","/xRWht48C2V8XNfzvPehyClOvDni.jpg","When Alita awakens with no memory of who she is in a future world she does not recognize, she is taken in by Ido, a compassionate doctor who realizes that somewhere in this abandoned cyborg shell is the heart and soul of a young woman with an extraordinary past."));
        movies.add(new Movies("Toy Story 4","/m67smI1IIMmYzCl9axvKNULVKLr.jpg","Woody has always been confident about his place in the world and that his priority is taking care of his kid, whether that's Andy or Bonnie. But when Bonnie adds a reluctant new toy called \"Forky\" to her room, a road trip adventure alongside old and new friends will show Woody how big the world can be for a toy"));
        ...
        movies.add(new Movies("Captain Marvel","/10csMIye4Vmr5lJpx3cdmMN8FOT.jpg","The story follows Carol Danvers as she becomes one of the universe’s most powerful heroes when Earth is caught in the middle of a galactic war between two alien races. Set in the 1990s, Captain Marvel is an all-new adventure from a previously unseen period in the history of the Marvel Cinematic Universe."));
        movies.add(new Movies("Men in Black: International","/dPrUPFcgLfNbmDL8V69vcrTyEfb.jpg","The Men in Black have always protected the Earth from the scum of the universe. In this new adventure, they tackle their biggest, most global threat to date: a mole in the Men in Black organization."));
        movies.add(new Movies("Toy Story 4","/m67smI1IIMmYzCl9axvKNULVKLr.jpg","Woody has always been confident about his place in the world and that his priority is taking care of his kid, whether that's Andy or Bonnie. But when Bonnie adds a reluctant new toy called \"Forky\" to her room, a road trip adventure alongside old and new friends will show Woody how big the world can be for a toy"));
        movies.add(new Movies("Burglary","/xztkk3qwvjTfKArjTkhWUCuadFY.jpg","While playing videogames Mike spots a mysterious masked man outside his building."));
